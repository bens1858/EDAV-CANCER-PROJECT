...
Part of our research questions were to investigate cancer rates among Rave, Poverty Level, Sex, Disability Status, Age Groups, Employment Status, Region and Urbanicity. 
...
Age groups are greatly distributed among the cancer rates that they have. While within each age subgroup, the cancer estimate remains relatively the same, as age increases, the estimated cancer rate in that subgroup increases. In the Race group, the White and American Indian, Alaska Native and White subgroups have higher cancer rates than Asian only or Black only. It would need to be investigated if the sampled population have different accesses to health care or if this is a result of systemic policies in the health care system. Those who are in the unemployed (has worked previously) and not employed categories have higher rates of cancer than those in the never employed, full-time and employed categories. The difference between not employed and unemployed (worked previously) is unclear in the data source. The individuals who have a a disability are reported to have the double the cancer estimate as the individuals without a disability. 
